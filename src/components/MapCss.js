...
function Map({ children, wasSelected }) {
  ...
  return (
    <MapCss>
      <div className="mapdiv">
        ...
        <svg viewBox="0 0 1000 948" xmlns="http://www.w3.org/2000/svg">
          <Link
            to={
              wasSelected
                ? "/wojewodztwa/warminsko-mazurskie"
                : "warminsko-mazurskie"
            }
          >
            <path
          ...
          <Link to={wasSelected ? "/wojewodztwa/pomorskie" : "pomorskie"}>
            <path
          ...
          <Link to={wasSelected ? "/wojewodztwa/dolnoslaskie" : "dolnoslaskie"}>
            <path
          ...
          <Link
            to={
              wasSelected
                ? "/wojewodztwa/zachodnio-pomorskie"
                : "zachodnio-pomorskie"
            }
          >
            <path
          ...
          <Link to={wasSelected ? "/wojewodztwa/lubuskie" : "lubuskie"}>
            <path
          ...
          <Link
            to={wasSelected ? "/wojewodztwa/wielkopolskie" : "wielkopolskie"}
          >
            <path
          ...
          <Link
            to={
              wasSelected
                ? "/wojewodztwa/kujawsko-pomorskie"
                : "kujawsko-pomorskie"
            }
          >
            <path
          ...
          <Link to={wasSelected ? "/wojewodztwa/slaskie" : "slaskie"}>
            <path
          ...
          <Link to={wasSelected ? "/wojewodztwa/lodzkie" : "lodzkie"}>
            <path
          ...
          <Link to={wasSelected ? "/wojewodztwa/mazowieckie" : "mazowieckie"}>
            <path
          ...
          <Link
            to={wasSelected ? "/wojewodztwa/swietokrzyskie" : "swietokrzyskie"}
          >
            <path
          ...
          <Link to={wasSelected ? "/wojewodztwa/podlaskie" : "podlaskie"}>
            <path
          ...
          <Link to={wasSelected ? "/wojewodztwa/lubelskie" : "lubelskie"}>
            <path
          ...
          <Link to={wasSelected ? "/wojewodztwa/podkarpackie" : "podkarpackie"}>
            <path
          ...
          <Link to={wasSelected ? "/wojewodztwa/opolskie" : "opolskie"}>
            <path
          ...
          <Link to={wasSelected ? "/wojewodztwa/malopolskie" : "malopolskie"}>
            <path
      ...
      <>
        {/* {lowiska.length > 0 && (
        <div className="lowiskadiv" ref={ref}>
          {lowiska.map((lowisko) => (
            <div key={lowisko.id}>
              <li className="lowi_itm">
                <Link to={`/lowisko/${lowisko.id}`}>
                  ...
                  <h2 className="lowi_itm_header">{lowisko.name}</h2>
