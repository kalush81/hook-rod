    ...
    <MapCss>
      <div className="mapdiv">
        ...
        <svg viewBox="0 0 1000 948" xmlns="http://www.w3.org/2000/svg">
          <Link to={"/wojewodztwo/warminsko-mazurskie"}>
            <path
          ...
          <Link to={"/wojewodztwo/dolnoslaskie"}>
            <path
          ...
          <Link to={"/wojewodztwo/zachodnio-pomorskie"}>
            <path
          ...
          <Link to={"/wojewodztwo/wielkopolskie"}>
            <path
          ...
          <Link to={"/wojewodztwo/kujawsko-pomorskie"}>
            <path
          ...
          <Link to={"/wojewodztwo/mazowieckie"}>
            <path
          ...
          <Link to={"/wojewodztwo/swietokrzyskie"}>
            <path
          ...
          <Link to={"/wojewodztwo/podkarpackie"}>
            <path
          ...
          <Link to={"/wojewodztwo/malopolskie"}>
            <path
